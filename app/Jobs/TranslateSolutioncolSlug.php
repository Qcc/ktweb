...
class TranslateProductcolSlug implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct(Solutioncol $solutioncol)
    {
        $this->solutioncol = $solutioncol;
    }
    ...
    {
        // 请求百度 API 接口进行翻译
        $slug = app(SlugTranslateHandler::class)->translate($this->solutioncol->name);
        ...
        \DB::table('solutioncols')->where('id',$this->solutioncol->id)->update(['slug' => $slug]);
    }
}
