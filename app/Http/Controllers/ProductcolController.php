...
{
    public function show(Product $product,Solution $solution, Request $request, Productcol $productcol)
    {
        ...
        // 传参变量话题和分类 到模版中
        return view('pages.product.products',compact('products','solutions','productcol'));
    }
}
