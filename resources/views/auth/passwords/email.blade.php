                    ...
                    <div id="sms-tab" class="mdui-p-a-2">
                        ...
                        <div class="code-form">
                            <form class="layui-form" method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
                                        <input type="password" name="confirmpassword" lay-verify="required" autocomplete="off"
                                            placeholder="确认密码" value="{{ old('confirmpassword') }}" class="layui-input {{ $errors->has('confirmpassword') ? 'layui-form-danger':'' }}">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
