<div class="usercard-message">
  <div class="mdui-btn-group">
    ...
    @if($topic->topping)
    <!-- 当前置顶状态标记1已经置顶，0未置顶 -->
    <button class="mdui-btn mdui-ripple topic-topping" topping='1' title="取消话题置顶" style="color:#00C853"><i class="mdui-icon material-icons">&#xe5ca;</i> 已置顶</button>
    @else
    <button class="mdui-btn mdui-ripple topic-topping" topping='0' title="将话题置顶"><i class="mdui-icon material-icons">&#xe25a;</i> 置顶</button>
    @endif
    ...
    @if($topic->excellent)
    <button class="mdui-btn mdui-ripple topic-excellent" title="取消将话题设置为精华" style="color:#00C853"><i class='mdui-icon material-icons'>&#xe5ca;</i>
      已加精</button>
    @else
    <button class="mdui-btn mdui-ripple topic-excellent" title="将话题设置为精华"><i class="mdui-icon material-icons">&#xe83a;</i>
      加精华</button>
    @endif
    @endguest
  </div>