<header class="kt-nav-header">
    ...
    <div class="kt-nav-warp">
      ...
      <nav class="kt-nav-login mdui-hidden-sm-down">
        ...
        @else
        @role('站长')
        <a href="javascript:;" style="margin: 0 10px;" mdui-menu="{target: '#user-article'}" class="kt-navigetion-sections " title="新建主站资讯">发布资讯<i class="kticon">&#xe658;</i></a>
        @endrole
    ...
    <div class="mdui-container-fluid kt-menu-warp">
        ...
        <div class="mdui-row">
          <div class="mdui-col-xs-8">
            <ul class="navigation-product">
              <li class="navigetion-sections-title"><a href="{{ route('products.show',1) }}" class="kt-navigetion-sections"><i class="kticon">&#xe6a5;</i>
                  应用虚拟化</a></li>
            ...
            <ul class="navigation-product">
              <li class="navigetion-sections-title"><a href="{{ route('products.show',4) }}" class="kt-navigetion-sections"><i class="kticon">&#xe661;</i>
                  金蝶云</a></li>
            ...
            <ul class="navigation-product">
              <li class="navigetion-sections-title"><a href="{{ route('products.show',8) }}" class="kt-navigetion-sections"><i class="kticon">&#xe6a5;</i>
                  ERP</a></li>
      ...
      <div class="kt-menu-panl animated fadeInDown">
        <div class="mdui-row">
          <div class="mdui-col-xs-8">
            <ul class="navigation-product">
              <li class="navigetion-sections-title"><a href="{{ route('solutions.show',1) }}" class="kt-navigetion-sections"><i class="kticon">&#xe607;</i>
                  制造业</a></li>
            ...
            <ul class="navigation-product">
              <li class="navigetion-sections-title"><a href="{{ route('solutions.show',6) }}" class="kt-navigetion-sections"><i class="kticon">&#xe61b;</i>
                  服务行业</a></li>
            ...
            <ul class="navigation-product">
              <li class="navigetion-sections-title"><a href="{{ route('solutions.show',11) }}" class="kt-navigetion-sections"><i class="kticon">&#xe6e5;</i>
                  零售业</a></li>
            ...
            <ul class="navigation-product">
              <li class="navigetion-sections-title"><a href="{{ route('solutions.show',13) }}" class="kt-navigetion-sections"><i class="kticon">&#xe685;</i>
                  政府机构</a></li>
      ...
      <div class="mdui-hidden-md-up ktm-nav-content animated fadeInDown">
        <ul class="ktm-menu-products">
          ...
          <li class="kt-navigetion-item"><a href="{{ route('products.show',5) }}" class="kt-navigetion-sections"><i class="kticon">&#xe661;</i>
              金蝶云·星空</a></li>
          <li class="kt-navigetion-item"><a href="{{ route('products.show',10) }}" class="kt-navigetion-sections"><i class="kticon">&#xe6a5;</i>
              金蝶ERP</a></li>
          ...
          <li class="kt-navigetion-btn"><a class="mdui-btn mdui-color-theme-accent mdui-ripple" href="{{ route('register') }}">注册有礼<i class="kticon">&#xe655;</i></a></li>
          @else
