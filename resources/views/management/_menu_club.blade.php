<div class="edit-item">
        <ul class="edit-list">
                ...
                <li><a href="{{ route('admin.club.load') }}" class="mdui-btn mdui-ripple {{ active_class(if_route('admin.club.load'), $activeClass = 'mdui-color-theme-accent', $inactiveClass = '') }} ">
                                <i class="kticon">&#xe647;</i> 批量发布</a></li>
                @can('manage_logs')
